...
dataset = "2 - Sales Pipeline Power BI" # Enter the name or ID of the semantic model
workspace = "ws-demo-sea2" # Enter the workspace name or ID in which the semantic model exists
